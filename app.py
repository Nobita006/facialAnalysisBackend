...
def analyze():
    ...
    # Fetch BBC articles using the utility function
    ...
    # Prepare minimal output for each article
    articles_output = [{
        "Title": art["Title"],
        "Summary": art["Summary"],
    ...
    # Perform analysis on the articles
    ...
    # Determine majority sentiment based on analysis
    ...
    # Generate TTS audio for the sentiment analysis
